...
require_once $path."/attendancemanager/database/sessionDetails.php";
require_once $path."/attendancemanager/database/facultyDetails.php";
require_once $path."/attendancemanager/database/courseRegistrationDetails.php";
require_once $path."/attendancemanager/database/attendanceDetails.php";
...
if(isset($_REQUEST['action']))
{
    ...
    if($action=="downloadSummaryReport"||$action=="downloadDetailsReport")
    {
        ...
        //$rv=$ado->saveAttendance($dbo,$sessionid,$courseid,$facultyid,$studentid,$ondate,$status);
         ...
         $filename="/attendancemanager/report.csv";
